...
CREATE TABLE IF NOT EXISTS pedido (
  ...
  cd_expirado_pedido TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS mensagem (
  ...
  cd_isVisible_mensagem TINYINT NOT NULL DEFAULT 1,
  cd_chat_mensagem INT NOT NULL,
  cd_usuario_mensagem INT NOT NULL,
  ds_time_mensagem DATETIME NOT NULL DEFAULT current_timestamp,
...
INSERT INTO produto(nm_produto, sg_medida_produto, nm_tipoFisico_produto) VALUES("Arroz", "KG", "solido");
INSERT INTO produto(nm_produto, sg_medida_produto, nm_tipoFisico_produto) VALUES("Macarrão", "KG", "solido");
INSERT INTO produto(nm_produto, sg_medida_produto, nm_tipoFisico_produto) VALUES("Feijão", "KG", "solido");
